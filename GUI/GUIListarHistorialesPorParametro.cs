...
{
    public partial class GUIListarHistorialesPorParametro : Form
    {
        private FirestoreDb db;
        public GUIListarHistorialesPorParametro()
        {
            InitializeComponent();
        }

        private void GUIListarHistorialesPorParametro_Load(object sender, EventArgs e)
        {
